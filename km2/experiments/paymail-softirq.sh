...
# 念のため結果CSVは毎回新規。出力: km2/experiments/results-paymail.csv
# ============================================================================
set -u
NS=exp
...
CSV=${CSV:-$REPO/km2/experiments/results-paymail.csv}
LOG=${LOG:-$REPO/km2/experiments/paymail.log}
...
run_load() { # run_time capture
  ...
  local logfile="$REPO/km2/experiments/last-logs-paymail.txt"
  printf '%s\n' "$logs" > "$logfile"
